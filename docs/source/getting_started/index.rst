   ...
   .. tab:: Go
      ...
      .. code-block:: bash
         ...
         protoc \
             -I ansys/api/fluent/v1 \
             --go_out=<out> \
             --go_opt=Mansys/api/fluent/v1/health.proto=github.com/ansys/ansys-api-fluent/v1 \
             --go-grpc_out=<out> \
             --go-grpc_opt=Mansys/api/fluent/v1/health.proto=github.com/ansys/ansys-api-fluent/v1 \
             ansys/api/fluent/v1/health.proto
