"""Installation file for the ansys-api-fluent package"""
...
class build_py(BuildPyCommand):
    def build_package_data(self) -> None:
        self.data_files = [(package, src_dir, build_dir, [f for f in filenames if not f.endswith(".proto")]) for package, src_dir, build_dir, filenames in self.data_files]
